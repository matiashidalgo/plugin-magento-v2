...
class Decidir_DecidirPlanesDePago_Block_Adminhtml_Tarjeta_Edit_Tab_Formedit extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField("clave", "text", array(
            "label" => Mage::helper("decidirplanesv1")->__("decidir"),
            "name" => "clave",
            "required" => true,
