...
class Decidir_DecidirPlanesDePago_Block_Adminhtml_Tarjeta_Editedit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("tarjeta_data") && Mage::registry("tarjeta_data")->getId() ){
				    ...
				    return Mage::helper("decidirplanesv1")->__("Editar medio de pago", $this->htmlEscape(Mage::registry("tarjeta_data")->getId()));
